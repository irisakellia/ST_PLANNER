    ...
    <div>
       <div>
        ...
        <nav className='inline-flex bg-gradient-to-r from-blue-950 via-blue-600 to-blue-300 w-full'>
          ...
          <p className='text-white font-medium text-xl ml-96 mt-10'><Link>Scheduling</Link></p>
          <p className='text-white font-medium text-xl ml-20 mt-10'><Link>Tasks</Link></p>
          <p className='text-white font-medium text-xl ml-20 mt-10'><Link>Reminders</Link></p>
